...
public class Message implements Notification {
    ...
    /**
     * Get image with the message returns null if the message is a text message
     */
    ...
    /**
     * Get message's tagged User null if theres no valid User tagged
     */
    ...
    /**
     * Searches the text for the taggedUsers initializes the taggedUsers property
    ...
    // // (2) Searches the whole message for @ symbol and stores string as username
    // after @
    ...
    // // (3) Searches the members from the group and adds the taggedUsers to the
    // ArrayList
