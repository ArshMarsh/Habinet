...
import Classes.DB;
import Classes.User;
import ForgotPassword.ForgotPassPage;
...
*/
public class LoginForm extends RoundPanel
{
    // Properties
    ...
    public void components(){
        EmailField = new HintTextField("Enter Username");
    ...
    class LoginListener implements ActionListener
    {
        ...
        {           
            ...
            if (EmailField.getText().equals("Enter Username")
                ...
                if (userID <= 0) {
                   ...
                   new app(new User(EmailField.getText(), PasswordField.getText()));
                   closePage();  
                } 
            }     
        }
