 ...
 */
public class RegisterForm extends RoundPanel {
    ...
    private void RegisterButtonActionPerformed(ActionEvent evt) {
        ...
        if ( UsernameField.getText().equals("Choose your Username")
            ...
            //New user Object Created and DB added
            newUser = new User(UsernameField.getText(), PasswordField.getText(), EmailField.getText(), mode, 1, 0 , 0, 0) ;         
